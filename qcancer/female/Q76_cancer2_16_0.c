 ...
 *   However, the nature of the GNU Lesser General Public License is such that we cannot prevent, for example, someone making a mistake or altering the coefficients.
