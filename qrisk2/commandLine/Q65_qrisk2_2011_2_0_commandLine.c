...
void usage(void) {
	...
	printf(" * XML source: Q65_qrisk2_2011_2_0.xml\n");
	printf(" * STATA dta time stamp: 9 Jan 2011 22:05\n");
	printf(" * C file create date: Thu May  5 10:09:22 BST 2011\n");
	printf(" *\n");
	printf("Usage:\n");
	printf("  Q65_qrisk2_2011_2_0_commandLine age b_AF b_ra b_renal b_treatedhyp b_type2 bmi ethrisk fh_cvd rati sbp smoke_cat surv town\n");
}
