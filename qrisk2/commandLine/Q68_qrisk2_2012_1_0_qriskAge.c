...
void usage(void) {
	...
	printf(" *\n");
	printf("Usage:\n");
	printf("  Q68_qrisk2_2012_1_0_qriskAge age b_AF b_ra b_renal b_treatedhyp b_type2 bmi ethrisk fh_cvd rati sbp smoke_cat surv town\n");
}
...
int main (int argc, char *argv[]) {
	...
	int qAge = qriskAge(0, ethrisk, score);
	if (qAge != -1) {
		printf("%d\n", qAge);
	}
	else {
