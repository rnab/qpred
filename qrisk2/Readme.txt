Welcome to QRISK2-2012 (http://qrisk.org)
--
...
To compile QRISK2-2012 on a UNIX-like system, type
 make
to create the command line executables.

Please check http://svn.clinrisk.co.uk/qrisk2 for the latest sources.
We expect to update the QRISK2-2012 algorithm(s) annually.  
