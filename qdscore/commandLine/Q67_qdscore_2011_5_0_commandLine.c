 ...
 * C file create date: Wed 22 Jun 2011 10:48:53 BST
 */
...
void usage(void) {
	...
	printf(" * XML source: Q67_qdscore_2011_5_0.xml\n");
	printf(" * STATA dta time stamp: 9 May 2011 11:01\n");
	printf(" * C file create date: Wed 22 Jun 2011 10:48:53 BST\n");
	printf(" *\n");
	printf("Usage:\n");
	printf("  Q67_qdscore_2011_5_0_commandLine age b_corticosteroids b_cvd b_treatedhyp bmi ethrisk fh_diab smoke_cat surv town\n");
}
